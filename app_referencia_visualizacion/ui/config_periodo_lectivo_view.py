...
class ConfigPeriodoView(ctk.CTkFrame):
    def __init__(self, master):
        ...
        # Separador
        ctk.CTkFrame(fr_form, height=2, fg_color="#404040").pack(fill="x", pady=15)
        ...
        stats_data = [
            ("👥 Alumnos Matriculados", "250", st.Colors.ASISTENCIA),
            ("📚 Cursos Activos", "15", "#2ecc71"),
            ("👨‍🏫 Docentes Asignados", "12", "#f39c12"),
            ("💰 Ingresos Totales", "S/ 125,000", st.Colors.PUNTUAL)
        ]
        ...
        # Separador
        ctk.CTkFrame(fr_stats, height=2, fg_color="#404040").pack(fill="x", pady=20)
        ...
        fr_progreso = ctk.CTkFrame(fr_stats, fg_color="#2b2b2b", corner_radius=10)
        ...
        self.progress_periodo = ctk.CTkProgressBar(
            ...
            height=20,
            corner_radius=10,
            progress_color=st.Colors.ASISTENCIA
        )
        self.progress_periodo.pack(fill="x", pady=(0, 5))
        self.progress_periodo.set(0.45)  # 45% completado
        ...
        # Info adicional
        fr_info = ctk.CTkFrame(fr_stats, fg_color="#1a1a1a", corner_radius=10)
        fr_info.pack(fill="x", pady=(20, 0))
        
        ctk.CTkLabel(
            fr_info,
            text="ℹ️ Información del Periodo",
            font=("Roboto", 11, "bold"),
            text_color="#3498db"
...
• Creado el: 25 de febrero de 2026
        ...
        fr_accion1 = ctk.CTkFrame(fr_acciones, fg_color="#2b2b2b", corner_radius=10)
        ...
        fr_accion2 = ctk.CTkFrame(fr_acciones, fg_color="#2b2b2b", corner_radius=10)
        ...
        # Advertencia
        fr_warning = ctk.CTkFrame(fr_acciones, fg_color="#c0392b", corner_radius=10)
...
• Esta acción NO se puede deshacer
    ...
    def crear_item_periodo(self, anio, ciclo, fecha_inicio, fecha_fin, alumnos, estado, activo):
        ...
        bg = "#2b2b2b" if not activo else "#34495e"
        
        fr_periodo = ctk.CTkFrame(
            self.scroll_periodos,
            fg_color=bg,
            corner_radius=10
        )
        ...
        color_barra = st.Colors.PUNTUAL if activo else "#7f8c8d"
        ctk.CTkFrame(
            fr_periodo,
            width=5,
    ...
    def crear_card_estadistica(self, parent, titulo, valor, color):
        ...
        fr_card = ctk.CTkFrame(parent, fg_color="#2b2b2b", corner_radius=10)
    ...
    def calcular_duracion(self, event=None):
        ...
        try:
            ...
            self.lbl_duracion.configure(text=texto, text_color="#7f8c8d")
        
        except:
            self.lbl_duracion.configure(text="📊 Duración: --", text_color="#7f8c8d")
    ...
    def crear_periodo(self):
        ...
        ciclo = self.combo_ciclo.get().split()[0]  # Extraer "I", "II", etc.
        fecha_inicio = self.cal_inicio.get_date()
        fecha_fin = self.cal_fin.get_date()
