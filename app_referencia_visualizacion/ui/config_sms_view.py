# app/ui/views/config_sms_view.py
"""
Vista de Configuración de SMS - SOLO INTERFAZ VISUAL
...
class ConfigSMSView(ctk.CTkFrame):
    ...
    def _crear_encabezado(self):
        ...
        titulo = ctk.CTkLabel(
            header_frame,
            text="⚙️ CONFIGURACIÓN DE NOTIFICACIONES SMS",
            font=("Roboto", 28, "bold"),
            text_color="#4CAF50"
        )
    ...
    def _crear_seccion_proveedor(self):
        ...
        providers_frame = ctk.CTkFrame(frame, fg_color="#1a1a1a", corner_radius=8)
        providers_frame.pack(fill="x", padx=10, pady=10)
        
        proveedores = [
            ("Twilio", "twilio", "#F22F46"),
            ("AWS SNS", "aws", "#FF9900"),
            ("Gateway Local", "gateway_local", "#4CAF50")
        ]
    ...
    def _crear_seccion_notificaciones(self):
        ...
        notif_frame = ctk.CTkFrame(frame, fg_color="#1a1a1a", corner_radius=8)
    ...
    def _crear_seccion_plantillas(self):
        ...
        preview_frame = ctk.CTkFrame(frame, fg_color="#2d2d2d", corner_radius=8)
    ...
    def _crear_seccion_estadisticas(self):
        ...
        tabla_frame = ctk.CTkFrame(frame, fg_color="#2d2d2d", corner_radius=8)
        ...
        header_frame = ctk.CTkFrame(tabla_frame, fg_color="#3d3d3d", corner_radius=0)
        ...
        # Datos de ejemplo
        datos = [
            ("📱 Asistencia", "3,520", "S/. 668.80", "#4CAF50"),
            ("❌ Inasistencia", "880", "S/. 167.20", "#F44336"),
        ...
        # Separador
        separator = ctk.CTkFrame(tabla_frame, fg_color="#555555", height=2)
    ...
    def _crear_card(self, titulo):
        ...
        card = ctk.CTkFrame(self.scroll_frame, fg_color="#2d2d2d", corner_radius=10)
    ...
    def _crear_campo_config(self, parent, label, placeholder, attr_name, boton_texto=None, boton_comando=None):
    ...
    def _validar_credenciales(self):
        ...
        threading.Timer(1.5, lambda: self._ocultar_cargando_y_mensaje(
    ...
    def _probar_sms(self):
        ...
        threading.Timer(2, lambda: self._ocultar_cargando_y_mensaje(
            "SMS Enviado",
    ...
    def _guardar_configuracion(self):
        ...
        threading.Timer(1, lambda: self._ocultar_cargando_y_mensaje(
    ...
    def _enviar_sms_prueba(self):
        ...
        # Diálogo para ingresar número
        dialogo = ctk.CTkInputDialog(
            text="Ingrese el número de celular para la prueba:",
            title="SMS de Prueba"
        )
